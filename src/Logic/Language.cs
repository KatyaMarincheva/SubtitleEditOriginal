...
Keep changes?", SynchronizationDone = "Sync done!", StartSceneMustComeBeforeEndScene = "Start scene must come before end scene!", Tip = "Tip: Use <ctrl+arrow left/right> keys to move 100 ms back/forward", };
        ...
        /// <summary>
        /// The get current language as xml.
        /// </summary>
        /// <returns>
        /// The <see cref="string"/>.
        /// </returns>
        ...
        {
            File.WriteAllText(fileName, this.GetCurrentLanguageAsXml(), Encoding.UTF8);
        }
    }
}