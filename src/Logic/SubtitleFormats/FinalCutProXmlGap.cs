// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FinalCutProXmlGap.cs" company="">
//   
// </copyright>
// <summary>
//   The final cut pro xml gap.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Nikse.SubtitleEdit.Logic.SubtitleFormats
{
    ...
    public class FinalCutProXmlGap : SubtitleFormat
    {
        ...
        public override string ToText(Subtitle subtitle, string title)
        {
            ...
            string xmlStructure = "<?xml version=\"1.0\" encoding=\"utf-8\" standalone=\"no\"?>" + Environment.NewLine + "<!DOCTYPE fcpxml>" + Environment.NewLine + Environment.NewLine + "<fcpxml version=\"1.2\">" + Environment.NewLine + "  <project name=\"Subtitle Edit subtitle\" uid=\"C1E80D31-57D4-4E6C-84F6-86A75DCB7A54\" eventID=\"B5C98F73-1D7E-4205-AEF3-1485842EB191\" location=\"file://localhost/Volumes/Macintosh%20HD/Final%20Cut%20Projects/Yma%20Sumac/Yma%20LIVE%20in%20Moscow/\" >" + Environment.NewLine + "    <resources>" + Environment.NewLine + "      <format id=\"r1\" name=\"FFVideoFormatDV720x480i5994\" frameDuration=\"2002/60000s\" fieldOrder=\"lower first\" width=\"720\" height=\"480\" paspH=\"10\" paspV=\"11\"/>" + Environment.NewLine +
                                  ...
                                  "      <effect id=\"r6\" name=\"Custom\" uid=\".../Titles.localized/Build In:Out.localized/Custom.localized/Custom.moti\"/>" + Environment.NewLine + "    </resources>" + Environment.NewLine + "    <sequence duration=\"10282752480/2400000s\" format=\"r1\" tcStart=\"0s\" tcFormat=\"NDF\" audioLayout=\"stereo\" audioRate=\"48k\">" + Environment.NewLine + "      <spine>" + Environment.NewLine + "        <gap offset=\"0s\" name=\"Espace\" duration=\"645900/2500s\" start=\"0s\"></gap>" + Environment.NewLine + "      </spine>" + Environment.NewLine + "    </sequence>" + Environment.NewLine + "  </project>" + Environment.NewLine + "</fcpxml>";

            string xmlClipStructure = "  <title lane=\"6\" offset=\"4130126/60000s\" ref=\"r1\" name=\"\" duration=\"288288/60000s\" start=\"216003788/60000s\" role=\"Subtitles\">" + Environment.NewLine + "    <adjust-transform position=\"0.267518 -32.3158\"/>" + Environment.NewLine + "    <text></text>" + Environment.NewLine + "  </title>";
            ...
            try
            {
                ...
                foreach (XmlNode node in xml.SelectNodes("fcpxml/project/sequence/spine/gap"))
                {
                    try
                    {
                        ...
                        {
                            XmlNodeList textNodes = title.SelectNodes("text");
