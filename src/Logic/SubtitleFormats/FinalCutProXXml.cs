// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FinalCutProXXml.cs" company="">
//   
// </copyright>
// <summary>
//   The final cut pro x xml.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Nikse.SubtitleEdit.Logic.SubtitleFormats
{
    ...
    public class FinalCutProXXml : SubtitleFormat
    {
        ...
        public override string ToText(Subtitle subtitle, string title)
        {
            ...
            string xmlClipStructure = "  <title lane=\"6\" offset=\"4130126/60000s\" ref=\"r6\" name=\"\" duration=\"288288/60000s\" start=\"216003788/60000s\" role=\"Subtitles\">" + Environment.NewLine + "    <adjust-transform position=\"0.267518 -32.3158\"/>" + Environment.NewLine + "    <text></text>" + Environment.NewLine + "  </title>";
            ...
            try
            {
                ...
                foreach (XmlNode node in xml.SelectNodes("fcpxml/project/sequence/spine/clip"))
                {
                    try
                    {
                        ...
                        {
                            XmlAttribute role = title.Attributes["role"];
                            if (role != null && role.InnerText == "Subtitles")
                            {
                                XmlNode textNode = title.SelectSingleNode("text");
