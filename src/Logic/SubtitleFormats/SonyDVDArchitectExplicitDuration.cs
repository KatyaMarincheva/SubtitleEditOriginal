// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SonyDVDArchitectExplicitDuration.cs" company="">
//   
// </copyright>
// <summary>
//   The sony dvd architect explicit duration.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Nikse.SubtitleEdit.Logic.SubtitleFormats
{
    ...
    public class SonyDVDArchitectExplicitDuration : SubtitleFormat
    {
        ...
        public override string Name
        {
            get
            {
                return "Sony DVDArchitect Explicit duration";
            }
        }
        ...
        public override string ToText(Subtitle subtitle, string title)
        {
            ...
            foreach (Paragraph p in subtitle.Paragraphs)
            {
                ...
                sb.AppendLine(string.Format("{0:00}:{1:00}:{2:00}.{3:000}\t{4:00}:{5:00}:{6:00}.{7:000}\t{8:00}:{9:00}:{10:00}.{11:000}\t{12}", p.StartTime.Hours, p.StartTime.Minutes, p.StartTime.Seconds, p.StartTime.Milliseconds, p.EndTime.Hours, p.EndTime.Minutes, p.EndTime.Seconds, p.EndTime.Milliseconds, p.Duration.Hours, p.Duration.Minutes, p.Duration.Seconds, p.Duration.Milliseconds, text));
            }
