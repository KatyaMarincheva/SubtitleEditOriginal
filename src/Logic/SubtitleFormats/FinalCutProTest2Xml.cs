// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FinalCutProTest2Xml.cs" company="">
//   
// </copyright>
// <summary>
//   The final cut pro test 2 xml.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Nikse.SubtitleEdit.Logic.SubtitleFormats
{
    ...
    public class FinalCutProTest2Xml : SubtitleFormat
    {
        ...
        public override string Name
        {
            get
            {
                return "Final Cut Pro Test2 Xml";
            }
        }
