// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CapMakerPlus.cs" company="">
//   
// </copyright>
// <summary>
//   The cap maker plus.
            ...
            using (FileStream fs = new FileStream(fileName, FileMode.Create, FileAccess.Write))
            {
                ...
                for (int i = 0; i < subtitle.Paragraphs.Count; i++)
                {
                    ...
                    buffer = new byte[] { // styles 00 00 80 BF 00 00 00 C0 02 00 01 00
                                            0, 0, 0x80, // horizontal align, 0x80BF= center, 0x0000=left, 0x00c0=right
                                            0xBF, 0, 0, 0, 0xC0, // vertical Position: C0=bottom, 0=top
                                            2, // justification, 1=left, 2=center
                                            0, 1, // 1=normal font, 3=italic
                                            0 };
