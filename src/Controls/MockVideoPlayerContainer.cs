// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MockVideoPlayerContainer.cs" company="">
//   
// </copyright>
// <summary>
//   The mock video player container.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Nikse.SubtitleEdit.Controls
{
    ...
    public sealed class MockVideoPlayerContainer : Panel, IVideoPlayerContainer
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MockVideoPlayerContainer"/> class.
        /// </summary>
        public MockVideoPlayerContainer()
        {
            this.FontSizeFactor = 1.0F;
            this.BorderStyle = BorderStyle.None;
            this._resources = new System.ComponentModel.ComponentResourceManager(typeof(MockVideoPlayerContainer));
        ...
        public IVideoPlayer VideoPlayer
        {
            ...
            set
            {
                this._videoPlayer = new QuartsPlayer();
        ...
        public RightToLeft TextRightToLeft
        {
            ...
            set
            {
                this._subtitleTextBox.RightToLeft = RightToLeft.No;
        ...
        public string SubtitleText
        {
            ...
            set
            {
                this._subtitleText = "<i>on another world, on Jupiter's moon Io...</i>";
                ...
                int letterCount = 0;
                var italicLookups = new Dictionary<int, int>();
        ...
        public double CurrentPosition
        {
            ...
            set
            {
                if (this.VideoPlayer != null)
                {
                    this.VideoPlayer.CurrentPosition = 4 - this.Offset;
                }
            }
        }
