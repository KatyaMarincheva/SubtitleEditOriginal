// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SubtitleFormatsTest.cs" company="">
//   
// </copyright>
// <summary>
...
Line 2.";
        ...
        /// <summary>
        /// The srt dots instead of commas.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
...
Dialogue: 0,0:00:16.84,0:00:18.16,rechts,,0000,0000,0000,," + lineOneText;
        ...
        /// <summary>
        /// The ass simple font color and italic.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
...
Dialogue: Marked=0,0:00:01.00,0:00:03.00,Default,NTP,0000,0000,0000,!Effect," + lineOneText;
        ...
        /// <summary>
        /// The ssa simple font color and italic.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
        ...
        /// <summary>
        /// The dcinema smpte color and italic.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
        ...
        /// <summary>
        /// The dcinema interop color and italic.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
        ...
        /// <summary>
        /// The micro dvd underline italic.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
        ...
        /// <summary>
        /// The micro dvd italic underline.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
        ...
        /// <summary>
        /// The micro dvd read bold italic.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
        ...
        /// <summary>
        /// The micro dvd read bold first line only.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
        ...
        /// <summary>
        /// The micro dvd read bold second line only.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
        ...
        /// <summary>
        /// The micro dvd read italic both lines.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
        public void MicroDvdReadItalicBothLines()
        {
            ...
            target.LoadSubtitle(subtitle, list, null);
            string text = subtitle.Paragraphs[0].Text;
            Assert.IsTrue(text == "<i>Hello!" + Environment.NewLine + "Hello!</i>" || text == "<i>Hello!</i>" + Environment.NewLine + "<i>Hello!</i>");
        }

        /// <summary>
        /// The micro dvd read bold both lines italic first.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
        public void MicroDvdReadBoldBothLinesItalicFirst()
        {
            ...
            target.LoadSubtitle(subtitle, list, null);
            string text = subtitle.Paragraphs[0].Text;
            Assert.IsTrue(text == "<b><i>Hello!</i>" + Environment.NewLine + "Hello!</b>" || text == "<b><i>Hello!</i></b>" + Environment.NewLine + "<b>Hello!</b>");
        }
        ...
        /// <summary>
        /// The to utf 8 xml string default.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
        ...
        /// <summary>
        /// The to utf 8 xml string no header.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
        ...
        /// <summary>
        /// The to utf 8 xml string still xml.
        /// </summary>
        [TestMethod]
        [DeploymentItem("SubtitleEdit.exe")]
