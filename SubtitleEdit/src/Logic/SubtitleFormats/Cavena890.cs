namespace Nikse.SubtitleEdit.Logic.SubtitleFormats
{
    ...
    public class Cavena890 : SubtitleFormat
    {
        ...
        public void Save(string fileName, Subtitle subtitle)
        {
            ...
            using (FileStream fs = new FileStream(fileName, FileMode.Create, FileAccess.Write))
            {
                foreach (Paragraph p in subtitle.Paragraphs)
                {
                    ...
                    {
                        this._languageIdLine1 = LanguageIdChineseSimplified;
                        this._languageIdLine2 = LanguageIdChineseSimplified;
                        this._fontNameLine1 = "CCKM44";
                        this._fontNameLine2 = "CCKM44";
                        break;
                    }
                }
                ...
                {
                    this._languageIdLine1 = Configuration.Settings.SubtitleSettings.CurrentCavena890LanguageIdLine1;
                }

                if (Configuration.Settings.SubtitleSettings.CurrentCavena890LanguageIdLine2 >= 0)
                {
                    this._languageIdLine2 = Configuration.Settings.SubtitleSettings.CurrentCavena890LanguageIdLine2;
                }
                ...
                byte[] buffer = Encoding.ASCII.GetBytes("Subtitle Edit");
                ...
                buffer = new byte[] { 0xA0, 0x05, 0x04, 0x03, 0x06, 0x06, 0x08, 0x90, 0x00, 0x00, 0x00, 0x00, (byte)this._languageIdLine1, (byte)this._languageIdLine2, 0x2A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x90, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
                fs.Write(buffer, 0, buffer.Length);

                buffer = GetFontBytesFromLanguageId(this._languageIdLine1);
                fs.Write(buffer, 0, buffer.Length);

                buffer = new byte[] { 0x2E, 0x56, 0x44, 0x46, 0x4F, 0x4E, 0x54, 0x4C, 0x2E, 0x44, 0x01, 0x07, 0x01, 0x08, 0x00, 0xBF, 0x02, 0xBF, 0x02, 0x00, 0x00, 0x0D, 0xBF, 0x62, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
                fs.Write(buffer, 0, buffer.Length);

                buffer = GetFontBytesFromLanguageId(this._languageIdLine2);
                fs.Write(buffer, 0, buffer.Length);

                buffer = new byte[] { 0x2E, 0x56, 0x14, 0x56, 0x31, 0x30, 0x3A, 0x30, 0x30, 0x3A, 0x30, 0x30, 0x3A, 0x30, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x42, 0x54, 0x44 };
                fs.Write(buffer, 0, buffer.Length);
                ...
                foreach (Paragraph p in subtitle.Paragraphs)
                {
                    ...
                    WriteText(fs, p.Text, p == subtitle.Paragraphs[subtitle.Paragraphs.Count - 1], this._languageIdLine1, this._languageIdLine2);
        ...
        public override void LoadSubtitle(Subtitle subtitle, List<string> lines, string fileName)
        {
            ...
            this._languageIdLine1 = buffer[146];
            if (this._languageIdLine1 == 0)
            {
                this._languageIdLine1 = 1;
            }

            Configuration.Settings.SubtitleSettings.CurrentCavena890LanguageIdLine1 = this._languageIdLine1;

            this._languageIdLine2 = buffer[147];
            if (this._languageIdLine2 == 0)
            {
                this._languageIdLine2 = 1;
            }

            Configuration.Settings.SubtitleSettings.CurrentCavena890LanguageIdLine2 = this._languageIdLine2;

            this._fontNameLine1 = Encoding.ASCII.GetString(buffer, 187, 6);
            this._fontNameLine2 = Encoding.ASCII.GetString(buffer, 246, 6);

            // Hebrew
            if (!string.IsNullOrEmpty(this._fontNameLine1) && this._fontNameLine1 == "HEBNOA")
            {
                this._languageIdLine1 = LanguageIdHebrew;
            }

            if (!string.IsNullOrEmpty(this._fontNameLine2) && this._fontNameLine1 == "HEBNOA")
            {
                this._languageIdLine2 = LanguageIdHebrew;
            }

            if ((this._fontNameLine1 == "HEBNOA" || this._languageIdLine1 == LanguageIdHebrew) && this._fontNameLine2 == "NOFONT")
            {
                this._languageIdLine2 = LanguageIdHebrew;
                this._fontNameLine2 = "HEBNOA";
            }

            if ((this._fontNameLine2 == "HEBNOA" || this._languageIdLine2 == LanguageIdHebrew) && this._fontNameLine1 == "NOFONT")
            {
                this._languageIdLine1 = LanguageIdHebrew;
                this._fontNameLine1 = "HEBNOA";
            }

            // Chinese
            if (!string.IsNullOrEmpty(this._fontNameLine1) && this._fontNameLine1 == "CCKM44")
            {
                this._languageIdLine1 = LanguageIdChineseSimplified;
            }

            if (!string.IsNullOrEmpty(this._fontNameLine2) && this._fontNameLine1 == "CCKM44")
            {
                this._languageIdLine2 = LanguageIdChineseSimplified;
            }

            if ((this._fontNameLine1 == "CCKM44" || this._languageIdLine1 == LanguageIdChineseSimplified) && this._fontNameLine2 == "NOFONT")
            {
                this._languageIdLine2 = LanguageIdChineseSimplified;
                this._fontNameLine2 = "CCKM44";
            }
            else if ((this._fontNameLine1 == "CCKM44" || this._languageIdLine1 == LanguageIdChineseTraditional) && this._fontNameLine2 == "NOFONT")
            {
                this._languageIdLine2 = LanguageIdChineseTraditional;
                this._fontNameLine2 = "CCKM44";
            }

            if ((this._fontNameLine2 == "CCKM44" || this._languageIdLine2 == LanguageIdChineseSimplified) && this._fontNameLine1 == "NOFONT")
            {
                this._languageIdLine1 = LanguageIdChineseSimplified;
                this._fontNameLine1 = "CCKM44";
            }
            else if ((this._fontNameLine2 == "CCKM44" || this._languageIdLine2 == LanguageIdChineseTraditional) && this._fontNameLine1 == "NOFONT")
            {
                this._languageIdLine1 = LanguageIdChineseTraditional;
                this._fontNameLine1 = "CCKM44";
            }
            ...
            while (i < buffer.Length - 20)
            {
                ...
                string line1 = FixText(buffer, start, textLength, this._languageIdLine1);
                string line2 = FixText(buffer, start + textLength + 6, textLength, this._languageIdLine2);
        ...
        private static void WriteText(FileStream fs, string text, bool isLast, int languageIdLine1, int languageIdLine2)
        {
            ...
            byte[] buffer = GetTextAsBytes(line1, languageIdLine1);
            fs.Write(buffer, 0, buffer.Length);
        ...
        private static string FixText(byte[] buffer, int start, int textLength, int languageId)
        {
            ...
            {
                Encoding encoding = Encoding.Default; // which encoding?? Encoding.GetEncoding("ISO-8859-5")
            ...
            {
                // (_language == "CCKM44" || _language == "TVB000")
                int index = start;
